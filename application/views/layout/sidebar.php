 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-info elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo site_url().'dashboard' ?>" class="brand-link elevation-4">
     ...
     <!--  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php
            if ($page == 'sk_pribadi' || $page == 'sk_bersama' || $page == 'cuti' || $page == 'pengguna'){
              $menu_active = 'active';
              $menu_open = '';
            } else {
              $menu_active = '';
          ...
          <li class="nav-item <?php echo $menu_open ?>">
            <a href="<?php echo site_url().'berkas/home/pribadi' ?>" class="nav-link <?php echo $menu_open ?> <?php echo ($page == 'sk_pribadi') ? 'active':'' ?>">
          ...
          <!-- Bersama -->
          <li class="nav-item <?php echo $menu_open ?>">
            <a href="<?php echo site_url().'berkas/home/bersama' ?>" class="nav-link <?php echo $menu_open ?> <?php echo ($page == 'sk_bersama') ? 'active':'' ?>">
          ...
          <!-- Cuti -->
          <li class="nav-item <?php echo $menu_open ?>">
            <a href="<?php echo site_url().'cuti' ?>" class="nav-link <?php echo $menu_open ?> <?php echo ($page == 'cuti') ? 'active':'' ?>">
          ...
          <!-- Pengguna -->
          <li class="nav-item <?php echo $menu_open ?>">
            <a href="<?php echo site_url().'pengguna' ?>" class="nav-link <?php echo $menu_open ?> <?php echo ($page == 'pengguna') ? 'active':'' ?>">
